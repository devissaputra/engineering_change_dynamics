...
- `learner_state_sequence_model`
- `curriculum_knowledge_graph`

## Why this empirical bundle is distinct
This is an empirical software-intensive engineering change-management study using manually classified Apache commits. It does not model educational processes, learner sequences, or curriculum semantics.
